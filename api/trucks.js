...
export default function handler(req, res) {
    ...
    const paths = {
        phantom: path.join(root, 'data', 'phantom-data.json'),
        ragged: path.join(root, 'data', 'ragged-data.json'),
        crafted: path.join(root, 'data', 'crafted-hope-data.json'),
        manual: path.join(root, 'data', 'manual-data.json')
    };
